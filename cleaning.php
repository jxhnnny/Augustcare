...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $stmt = $dbh->prepare("SELECT id FROM cleaner WHERE Username = :username");
    ...
    $stmt = $dbh->prepare("SELECT id FROM cleaner WHERE Email = :email");
    ...
    if (empty($errors)) {
        ...
        // Prepare and bind
        $stmt = $dbh->prepare(
            "INSERT INTO cleaner (Fullname, Username, Email, PhoneNumber, Password, Age, Gender, DomesticWork, Price)
        ...
        <form action="" method="POST">
            ...
            <div class="form">
                ...
                <div class="input-box">
                    ...
                    <input type="number" id="age" name="age" required min="18" max="100" pattern="[0-9]+">
                </div><br>
                <div class=" gender-title">Gender
                </div>
                ...
                <div class="alert">
                    ...
                    <label>Already have account?</label><a href="nannylogin.php">login</a>
                </div>
