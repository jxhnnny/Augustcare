...
if (isset($_POST['login'])) {
    ...
    $sql = "SELECT ID, Username, Password FROM parentstbl WHERE Username = :username";
    ...
    if ($result) {
        ...
        if (password_verify($password, $result->Password)) {
            ...
            echo "<script type='text/javascript'> document.location = 'parentHome.php'; </script>";
        }
    } else {
        ...
        <div class="Login-Signup">
            <form action="" method="POST">
                ...
                <div class="input-field">
                    ...
                    <input type="text" name="userN" id="userN" placeholder="username" pattern="[A-Za-z]+" title="Only letters are allowed" required>
